...
namespace MathForGames
{
    class Engine
    {
        ...
        private void Start()
        {
            ...
            Actor actor = new Actor('P', new MathLibrary.Vector2 { X = 0, Y = 0 }, "Actor 1", ConsoleColor.Blue);
            Actor actor2 = new Actor('A', new MathLibrary.Vector2 { X = 10, Y = 10 }, "Actor 2", ConsoleColor.Green);
